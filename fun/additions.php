...
function yyuc_start(){
	...
	$_SERVER['WEB_URL'] = 'http://www.weiqimobile.com';//改成你的网址
	$_SERVER['WEI_URL'] = 'www.weiqimobile.com';//改成你的网址
	...
	$_SERVER['CHAT_JS'] = '283497031';

	$_SERVER['QQ_QUN'] = '305617976';
	...
	if($_SERVER ['HTTP_HOST'] =='121.199.59.187'|| $_SERVER ['HTTP_HOST'] == '223.6.250.136'|| $_SERVER ['HTTP_HOST'] == 'weixin.com'|| $_SERVER ['HTTP_HOST'] == 'wx.dxcx.com'){

		die();

	}

	if(strpos($_SERVER ['HTTP_HOST'], 'weixinguanjia.cn')==false){
