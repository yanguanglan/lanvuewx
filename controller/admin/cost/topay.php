...
if(trim($u->next_level_id)!='' && trim($u->next_level_id)!='1'){
	...
	if($online->save()){
		$csarr = array(
				...
				//'defaultbank'=>'CMB',
				'notify_url'=>'http://www.zkrr.com/czok.html',
				'out_trade_no'=>$online->id,				
				'partner'=>'2088002141416153',
				'payment_type'=>'1',
				//'paymethod'=>'bankPay',				
				'return_url'=>'http://www.zkrr.com/uczok.html',				
				'seller_email'=>'sunjg44152324@126.com',
		...
		$sign = md5($djmzc.'89o7o5i7exho0s9k2msfqjasdoartqrg');
