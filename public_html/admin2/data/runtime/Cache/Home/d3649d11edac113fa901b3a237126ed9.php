...
<div class="nav clearfix">
	<div class="nav-content">
		<h1 class="left" href="<?php echo C('site_url');?>"><?php echo C('site_name');?></h1>
		<div class="left city">
			<h2>全国</h2>
							<a href="#">
					切换城市<i class="tri4"></i>
		...
		<div class="right line-li">
			<ul>
				<li><a href="<?php echo C('site_url');?>" >首页</a></li>
		...
		<div class="banner">
			<ul>
					<li class="pic-intro" >
						<div class="text">
							<h4>
								已有<font>982</font>商家入驻<?php echo C('site_name');?>，微信营销 如此简单
							</h4>
...
<!--公告信息-->
	...
	<div id="notice_message" style="position: absolute; left: 373.5px; top: 20%;">
		...
		<div class="content">
    <?php echo C('site_name');?>系统全线升级，欢迎新老客户咨询体验，我们会一如既往的为您提供更优质的服务!</div>
	</div>
...
<!--QQ咨询-->
<script src="<?php echo C('site_url');?>/tpl/static/qqserver/qqserver.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="<?php echo C('site_url');?>/tpl/static/qqserver/qqserver.css"/>
				...
				<div class="online-tbox">
					<div style="text-align: center; "><strong>在线时间</strong><br>	08:30-17:30<br>
						...
						<span style="font-weight: bold; ">服务热线<br>
							<span style="font-weight: normal;">15981908861</span>
						</span>
					</div>
				</div>
			</div>
