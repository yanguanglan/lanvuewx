                            ...
                            <form action="" method="post" class="form-horizontal form-validate"><?php echo tk();  echo $set->hidden('id'); ?>
                                    ...
                                    <label class="control-label" for="cover">图文消息封面</label>
									  <div class="controls">
										...
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_pic','micro_weiweb_keywordpic');">选择封面</button>
                                ...
                                <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
									<?php echo Conf::$http_path; ?>weiweb/<?php echo Session::get('wid'); ?>/
                                    </div>
                                </div>
