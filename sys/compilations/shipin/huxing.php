...
<html>
    <head>
        ...
        <title>食品</title><script type="text/javascript">var yyuc_jspath = "/@system/";</script><script type="text/javascript" src="/@system/js/jquery.js"></script><script type="text/javascript" src="/@system/js/yyucadapter.js"></script>
                ...
                <?php $__i=0; foreach ((array)$v as $kk=>$vv) { $__i++; ?>
                    <li id="boxLi27">
                        ...
                        <div class="house_photo" style="display:none;">
                            <a href="huxingpic-<?php echo $vv->id; ?>.html" class="ico_type">食品服务图片</a>
                            <?php if (hasqj($vv)){ ?>
