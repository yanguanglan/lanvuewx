...
<section class="body">
	...
	<div id="imgs_box" class="box_swipe">
		<img class="mm" src="<?php echo $h->headpic;?>" style="width: 100%;">	
	</div>
	</div>
	<div class="cardexplain">
			...
			<ul class="round">
				...
				<li class="addr"><a href="http://api.map.baidu.com/marker?location=<?php echo $h->wd; ?>,<?php echo $h->jd; ?>&title=<?php echo $h->addr; ?>&name=<?php echo $h->addr; ?>&content=<?php echo $h->addr; ?>&output=html&src=weiba|weiweb"><span><?php echo $h->addr;?></span></a></li>
			</ul>
...
<span class="sp2"><a href="http://112.124.61.112/weiweb/3702/" style="color: #5e5e5e;font-size: 12px;">技术支持：<?php echo $_SERVER['WEB_NAME']; ?></a></span>
</div>
