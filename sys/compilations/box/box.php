...
<script type="text/javascript">
        ...
        window.shareData = {  
          "imgUrl": "http://www.vipweipin.com/res/box/box.jpg", 
          "timeLineLink": "<?php echo Conf::$http_path."box/box.html?wid=".$list1[0]->wid; ?>",
            "sendFriendLink": "<?php echo Conf::$http_path."box/box.html?wid=".$list1[0]->wid; ?>",
            "weiboLink": "<?php echo Conf::$http_path."box/box.html?wid=".$list1[0]->wid; ?>",
            "tTitle": "点击进入音乐盒",
            "tContent": "点击进入音乐盒",
            "fTitle": "点击进入音乐盒",
            "fContent": "点击进入音乐盒",
