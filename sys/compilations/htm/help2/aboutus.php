...
<meta content="<?php echo $_SERVER['WEB_NAME']; ?>，国内最大的微信公众智能服务平台，<?php echo $_SERVER['WEB_NAME']; ?>八大微体系：微菜单、微官网、微会员、微活动、微商城、微推送、微服务、微统计，企业微营销必备。" name="Description">
                ...
                <div class="span12">
                    <div class="box">
                        ...
                        <div class="bs-docs-example">
       					  <h4 class="text-success">什么是<?php echo $_SERVER['WEB_NAME']; ?>?</h4>
                            <p><?php echo $_SERVER['WEB_NAME']; ?>是一个专门针对微信公众账号提供营销推广服务的第三方平台。主要功能是针对微信商家公众号提供与众不同的、有针对性的营销推广服务。通过<?php echo $_SERVER['WEB_NAME']; ?>，用户可以轻松管理自己的微信各类信息，对微信公众账号进行维护、开展智能机器人、在线发优惠劵、抽奖、刮奖、派发会员卡、打造微官网、开启微团购等多种活动，对微信营销实现有效监控，极大扩展潜在客户群和实现企业的运营目标。<?php echo $_SERVER['WEB_NAME']; ?>平台很好的弥补了微信公众平台本身功能不足、针对性不强、交互不便利的问题，为商家公众账号提供更为贴心的、且是核心需求的功能和服务。在线优惠劵、转盘抽奖、微信会员卡等推广服务更是让微信成为商家推广的利器。智能客服的可调教功能让用户真正从微信繁琐的日常客服工作中解脱出来，真正成为商家便利的新营销渠道。</p>
                            <br>
                          <h4 class="text-success">为什么选择<?php echo $_SERVER['WEB_NAME']; ?>？</h4>
                          <h5 class="text-warning">o企业为什么要开通微信公众账号</h5>
                          ...
                          <h6 class="text-success">O 微信的粘性和使用惯性</h6>
                            ...
                            <p>功能单一、操作复杂、用户体验差、没有差异化功能。</p>
                              <br>
                          <h5 class="text-warning">o<?php echo $_SERVER['WEB_NAME']; ?>全面解决当前企业微信营销困境</h5>
                            ...
                            <table id="listTable" class="table table-bordered table-hover  dataTable">
                              ...
                              <tr>
                                <td>传统网络营销遭遇瓶颈</td>
                                <td><strong class="text-success">微营销成为企业营销新渠道</strong> <?php echo $_SERVER['WEB_NAME']; ?>为企业微信营销提供智能的服务平台和完整的解决方案</td>
                              </tr>
                              <tr>
                                <td>微信营销有理论、无方法，想法无法落地</td>
                                <td><strong class="text-success"><?php echo $_SERVER['WEB_NAME']; ?>——理论加实践的产物</strong> <?php echo $_SERVER['WEB_NAME']; ?>根据市场行业需求，制定行业标准解决方案。</td>
                              </tr>
                              <tr>
                                <td>腾讯对企业开发要求门槛过高</td>
                                <td><strong class="text-success"><?php echo $_SERVER['WEB_NAME']; ?>平台解决企业开发烦恼</strong> <?php echo $_SERVER['WEB_NAME']; ?>大部分技术研发人员来自百度、腾讯，强大的技术后盾企业微信开发提供有力的保障。</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td>企业定制开发成本高、周期长</td>
                                <td><strong class="text-success"><?php echo $_SERVER['WEB_NAME']; ?>——微信智能服务平台</strong> <?php echo $_SERVER['WEB_NAME']; ?>在定制开发的基础上，抽取大部分行业定制需求，对产品进行标准化，企业无需开发即可实现强大的功能。</td>
                              </tr>
                              <tr>
                                <td>微信5.0群发功能限制，个性化服务凸现</td>
                                <td><strong class="text-success"><?php echo $_SERVER['WEB_NAME']; ?>——功能强大，满足个性需求</strong> 针对微信商家公众号提供与众不同的、有针对性的、更为贴心的、核心需求的功能和服务</td>
                              </tr>
                            </tbody></table>
                              <br>
                          <h5 class="text-warning">o<?php echo $_SERVER['WEB_NAME']; ?>平台的优势</h5>
                            ...
                            <p><?php if (!$_SERVER['IS_OEM']){ ?>微企是掌中宝（股票代码：100189）投资<?php }else{  echo $_SERVER['WEB_NAME'];  } ?>，技术团队由国内知名IT公司（百度、腾讯）核心成员组成、其技术总监为原百度商务搜索部技术经理，商务总监为原腾讯IMG商务经理，运营团队有着丰富的互联网推广经验和资源，并与腾讯保持密切合作，因此可以为商家提供一个更智能、更便捷的微信公众服务平台。</p>
                            
                              <br>
                             <h5 class="text-warning">o<?php echo $_SERVER['WEB_NAME']; ?>提供的服务</h5>
                             <h6 class="text-success">O 专业企业微信提案</h6>
                             <p><strong>行业分析</strong></p>
                             <p>根据企业发展的现状、未来的发展趋势，以及遇到的竞争对手情况，<?php echo $_SERVER['WEB_NAME']; ?>帮助企业分析发展中将会遇到哪些问题？以及如何把握行业的最新动态？如何采取最佳的解决策略？<?php echo $_SERVER['WEB_NAME']; ?>将为您提供一套完整的、贴心的解决方案。</p>
                             <p><strong>解决方案</strong></p>
                             <p><?php echo $_SERVER['WEB_NAME']; ?>为企业提供行业报告、行业动态、行业案例，并与战略合作伙伴在全国重点行业城市，联手打造行业信息化战略目标，为参与系列活动的行业企业提供高质量的微信营销知识培训。</p>
                             <h6 class="text-success">O 资深客服服务</h6>
                             <p>1、 2年以上客服经验。</p>
                             <p>2、 跟踪用户需求，提供专业优化方案。</p>
                             <br>
                            <h5 class="text-warning">oVIP服务标准</h5>
