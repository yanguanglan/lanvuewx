...
<a href="http://wpa.qq.com/msgrd?v=3&uin=2943747028&site=qq&menu=yes" target="_blank" class="btn btn-warning" style="cursor:pointer">微企助手</a> 
                            ...
                            <div class="row-fluid dataTables_wrapper">
                             ...
                             <div class="alert">
                                    ...
                                    <strong>温馨提示</strong>：您还有<?php echo $xe; ?>个微信公众号配额，请珍惜使用名额！ <span class="line"><?php if (!$_SERVER['IS_OEM']){ ?>全国招商加盟火热进行中<?php } ?></span>
