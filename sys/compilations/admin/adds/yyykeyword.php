            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span12">
                                <h3><i class="icon-cog"></i>摇一摇--关键字设置</h3>
                            </div>
                        </div>
                            ...
                            <form action="" method="post" class="form-horizontal form-validate"><?php echo tk();  echo $set->hidden('id'); ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <?php echo $set->text('gjz','class="input-xlarge" required="required"'); ?>
                                        ...
                                        <span class="help-inline">触发时为 关键字+手机号</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <label class="control-label" for="cover">图文消息封面</label>
									  <div class="controls">
										...
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_pic','micro_yyy_keywordpic');">选择封面</button>
