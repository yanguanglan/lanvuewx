			  ...
			  <label class="control-label" for="answertype">菜单点击事件:</label>
			    <div class="controls">
					<select class="span2" id="answertype" name="answertype">
					  ...
					  <option value="res_wktv">微KTV</option>
					  <option value="res_wjd">微酒店</option>
					  <option value="res_wfc">微房产</option>
					  <option value="res_wmr">微美容</option>
					  <option value="res_wwy">微物业</option>
					  <option value="res_wzw">微政务</option>
					  <option value="res_wsp">微食品</option>
					  <option value="res_wly">微旅游</option>
					  <option value="res_wjs">微健身</option>
					  <option value="res_wjy">微教育</option>
					  <option value="res_wjb">微酒吧</option>
					  <option value="res_whq">微婚庆</option>
					  <option value="res_wzx">微装修</option>
					  <option value="res_whd">微花店</option>
					  <option value="res_wqc">微汽车</option>
					  <option value="res_wsc">微商城</option>
					  <option value="res_wcy">微餐饮</option>
					</select>
			   </div>
		  	</div>
	</div>
...
<!-- 微官网 -->
<div class="szcjbt" id="res_wgw">
<table class="table table-bordered">
						<tr>
							<th style="width:50px;">请选择</th>
							<th>微官网</th>
						</tr>
						<?php $__i=0; foreach ((array)$webres as $r) { $__i++; ?>
						<tr>
						<td>
						<input type="radio" name="rad_tw" value="<?php echo $r->id; ?>">
						</td>
