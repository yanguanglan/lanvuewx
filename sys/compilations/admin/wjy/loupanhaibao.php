							...
							<form action="" method="post" id="lbsForm" class="form-horizontal form-validate" ><?php echo tk();  echo $m->hidden('id'); ?>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic','micro_jiaoyu_haibaopic');">选择图片</button>
								...
								<div class="control-group">
									...
									<img class="thumb_img" src="<?php echo $m->pic1; ?>" id="pic1"  style="max-height:100px;" />
										...
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic1','micro_jiaoyu_haibaopic1');">选择图片</button>
											<span class="help-inline">建议尺寸：宽400像素，高720像素</span>
										</span>
									</div>
								</div>
								<div class="control-group">
									...
									<img class="thumb_img" src="<?php echo $m->pic2; ?>" id="pic2"  style="max-height:100px;" />
										...
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic2','micro_jiaoyu_haibaopic2');">选择图片</button>
											<span class="help-inline">建议尺寸：宽400像素，高720像素</span>
										</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<?php echo $m->hidden('pic3'); ?>									
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic3','micro_jiaoyu_haibaopic3');">选择图片</button>
											<span class="help-inline">建议尺寸：宽400像素，高720像素</span>
										</span>
									</div>
								</div>
									...
									<?php echo $m->hidden('pic4'); ?>									
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic4','micro_jiaoyu_haibaopic4');">选择图片</button>
											<span class="help-inline">建议尺寸：宽400像素，高720像素</span>
										</span>
									</div>
