					...
					<div class="box">
						...
						<div class="box-content">
							<form action="" method="post" id="lbsForm" class="form-horizontal form-validate" ><?php echo tk();  echo $m->hidden('id'); ?>
								...
								<div class="control-group">
									<label class="control-label">培训机构头部图片：</label>
									<div class="controls">
								...
								<div class="control-group">
									<label for="jiaoyu_desc" class="control-label">服务理念简介：</label>
									<div class="controls">
									<?php echo $m->texteditor('jianjie',1,'600px','100px'); ?>
									</div>
								</div>
								<div class="control-group">
									<label for="object_desc" class="control-label">培训机构简介：</label>
									<div class="controls">
								...
								<div class="control-group">
									<label for="traffic_desc" class="control-label">教育学员：</label>
									<div class="controls">
