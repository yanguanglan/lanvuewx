			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3><i class="icon-table"></i>食品服务管理</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="loupanhuxingadd.html" class="btn"><i class="icon-plus"></i>添加食品服务</a>
								...
								<div class="span4" style="text-align:right;">
									...
									<?php echo $tj->text('huxing','class="input-large" placeholder="请输入食品服务名称" '); ?>
								...
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											...
											<th class="span3">食品服务名称</th>
											<th class="span3">所属食品店面</th>
									...
									<?php $__i=0; foreach ((array)$res as $r ) { $__i++; ?>
									  ...
									  <?php }else{ ?>
																			<tr>
											<td colspan="6" style="text-align:center; height:30px;">没有任何食品服务信息</td>
										</tr>
										<?php } ?>
																	</table>
					    	</div>
