				...
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3>
									<i class="icon-table"></i>食品店面管理
									<small>如果您的整体食品项目由多个食品店面项目组成，请在此添加，如果没有可以不添加。</small>
								</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="ziloupanadd.html" class="btn"><i class="icon-plus"></i>添加食品店面</a>
								</div>
								<div class="span4" style="text-align:right;">
									<form action="" class="form-horizontal form-validate">
										<?php echo $tj->text('name','class="input-large" placeholder="请输入食品店面名称" '); ?>
							...
							<div class="row-fluid dataTables_wrapper">
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											<th class="span4">食品店面名称</th>
											<th class="span4">食品店面描述</th>
									...
									<?php $__i=0; foreach ((array)$res as $r ) { $__i++; ?>
									  ...
									  <?php }else{ ?>
										...
										<tr>
											<td colspan="4" style="text-align:center; height:30px;">没有任何食品店面信息</td>
										</tr>
								<?php } ?>									</table>
															</div>
						</div>
