					...
					<div class="box">
						...
						<div class="box-content">
							<form action="" method="post" id="transform" class="form-horizontal form-validate"><?php echo tk();  echo $m->hidden('id'); ?>
								...
								<div class="control-group">
									<label for="category_id" class="control-label">所属食品店面：</label>
									<div class="controls">
								...
								<div class="control-group">
									<label for="area" class="control-label">食品服务描述：</label>
									<div class="controls">
								...
								<div class="control-group">
									<label for="description" class="control-label">食品服务介绍：</label>
									<div class="controls">
									<?php echo $m->textarea('jianjie','class="input-large" style="height:80px;width:380px;"'); ?>	
									</div>
								</div>
								<div class="control-group">
									<label for="prices" class="control-label">食品服务图片：</label>
