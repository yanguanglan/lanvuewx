...
<input type="hidden" name="oldmusic" value="<?php echo $m->music;?>" >
                                     <a id="m1" class="audio { skin:'blue'}" href="http://static.hd3p.com/mp3/yougetme.mp3" ><?php echo $m->music;?></a> 
...
<input type="checkbox" name="deletemusic" value="1"> 删除音乐
                                </div>
                          ...
                          <!--   <div class="control-group">
                           ...
                           <?php if ($show){ ?>
                             ...
                             <div class="control-group">
                                ...
                                <input type="text" class="input-large" readonly  value="<?php echo getUrl('wXiTie'); ?>"/>
