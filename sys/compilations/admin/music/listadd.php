					...
					<div class="box">
						...
						<div class="box-content">
							<form action="" method="post" class="form-horizontal form-validate"><?php echo tk();  echo $m->hidden('id'); ?>
								...
								<div class="control-group">
									<label for="sort" class="control-label">图片链接：</label>
									<div class="controls">
									<?php echo $m->textarea('pic','class="input-xxlarge" style="height:80px;width:380px;" placeholder="可不填"'); ?>
										<span class="maroon">*</span>
										<span class="help-inline">数值越大越靠前</span>
									</div>
								</div>
								<div class="control-group">
									<label for="description" class="control-label">音乐盒列表介绍：</label>
									<div class="controls">
									<?php echo $m->textarea('ms','class="input-xxlarge" style="height:80px;width:380px;" placeholder="可不填"'); ?>
									</div>
								</div>
