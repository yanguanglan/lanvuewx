            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span12">
                                <h3><i class="icon-cog"></i>音乐盒--关键字设置</h3>
                            </div>
                        </div>
                            ...
                            <form action="" method="post" class="form-horizontal form-validate"><?php echo tk();  echo $set->hidden('id'); ?>
                                    ...
                                    <label class="control-label" for="cover">图文消息封面</label>
									  <div class="controls">
										...
										<span class="help-inline">
											<button class="btn select_img" type="button" onclick="setpic('pic_pic','micro_music_keywordpic');">选择封面</button>
                                ...
                                <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
									<?php echo Conf::$http_path; ?>box/box.html?wid=<?php echo Session::get('wid'); ?>
                                    </div>
                                </div>
