			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3><i class="icon-table"></i>音乐管理</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="musicadd.html" class="btn"><i class="icon-plus"></i>添加音乐</a>
								...
								<div class="span4" style="text-align:right;">
									...
									<?php echo $tj->text('huxing','class="input-large" placeholder="请输入特色音乐名称" '); ?>
								...
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											...
											<th class="span2">音乐名称</th>
											<th class="span1">所属列表</th>
											<th class="span3">音乐链接</th>
									...
									<?php $__i=0; foreach ((array)$res as $r ) { $__i++; ?>
									  <tr>
									     ...
									     <td><?php echo $list1[$r->zid]; ?></td>
									     <td><?php echo $r->pic; ?></td>
									    
									     <td>
									     	<a href="musicadd-<?php echo $r->id; ?>.html" class="btn"><i class="icon-edit"></i></a>
									  ...
									  <?php }else{ ?>
																			<tr>
											<td colspan="6" style="text-align:center; height:30px;">没有任何音乐信息</td>
										</tr>
										<?php } ?>
																	</table>
					    	</div>
...
function dellbs(id,o){
	if(id=='a'){
		...
		if(confirm('确定删除这些信息吗？')){
			ajax('music-del.html',{ id:ids.join(',')},function(){
				$('td').find('input[type="checkbox"]:checked').each(function(){
		...
		if(confirm('确定删除此条信息吗？')){
			ajax('music-del.html',{ id:id},function(){
