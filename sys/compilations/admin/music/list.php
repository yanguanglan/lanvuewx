				...
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3>
									<i class="icon-table"></i>音乐盒列表管理
									<small>管理您的音乐盒列表</small>
								</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="listadd.html" class="btn"><i class="icon-plus"></i>添加音乐盒列表</a>
								</div>
							...
							<div class="row-fluid dataTables_wrapper">
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											<th class="span2">列表名称</th>
											<th class="span2">列表描述</th>
											<th class="span4">图片链接</th>
									...
									<?php $__i=0; foreach ((array)$res as $r ) { $__i++; ?>
									  ...
									  <?php }else{ ?>
										...
										<tr>
											<td colspan="4" style="text-align:center; height:30px;">没有任何音乐盒信息</td>
										</tr>
								<?php } ?>									</table>
															</div>
						</div>
