						...
						<div class="box-content">
							...
							<form action="" method="post" class="form-horizontal form-validate" novalidate id="lbsForm"><?php echo tk();  echo $m->hidden('id'); ?>
                                ...
                                <div class="control-group">
									...
									<label for="traffic_desc" class="control-label">订单短信通知：</label>

									<div class="controls">

										<?php echo $m->text('noticetel','class="input-xlarge"'); ?>
                                ...
                                <div class="control-group">
									...
									<label for="traffic_desc" class="control-label">短信通知内容：</label>

									<div class="controls">

										<?php echo $m->textarea('noticecontent','class="input-xlarge"'); ?>
