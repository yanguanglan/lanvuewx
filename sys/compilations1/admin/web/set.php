                    ...
                    <div class="box">
                        ...
                        <div class="box-content" style="overflow: auto;">
                            <ul class="nav nav-tabs" id="liclickli">
								...
								<!-- <li><a href="javascript:;" did="#menu" data-toggle="tab">菜单导航模板</a></li>
                            ...
                            <div class="tab-content">
								<div class="tab-pane active in" id="relli0">
									<ul class="nav nav-tabs nav-tabs-google" style="border-bottom:none"></ul>
										...
										<!--<li class="free">
										<div class="mbtip" style="display:none;">描述</div>
										<label>
										<img src="http://stc.weimob.com/img/template/home-0.png?v=7" alt="模板0" title="模板0">
