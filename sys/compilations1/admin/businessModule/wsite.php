 ...
 -->  
	...
	<table class="table table-bordered">
    	...
    	<td><img src="/res/fmdtp.jpg"/></td>
					...
					<tr id="t_txt" rel="m_txt">
					<td style="border: none;" colspan="2"><?php echo $m->texteditor('txt','langType:"zh-cn",allowImageUpload:true,allowFlashUpload:false,allowMediaUpload:false,allowFileManager:false,items:kindeditor_item3,afterChange:setwbdnr','325px','200px'); ?></td>
					</tr>
