                    ...
                    <div class="box-content">
                        ...
                        <dl class="dl-horizontal">
                            ...
                            <dd style="margin-left: 20px;">
                                <p><strong><?php echo $user->un; ?></strong>：<b class="text-warning">套餐级别：<?php echo translate_level($user->level_id);  if ($time_cha <16 and $user->mendtime!=''){ ?> 试用版(15天)<?php } ?></b>  
                               ...
                               <!--  <a href="/admin/cost/topay.html"><i class="icon-arrow-up" title="升级"></i>升级</a> -->
                                <?php }else{ ?>
                                <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $_SERVER['CHAT_JS']; ?>&amp;site=qq&amp;menu=yes" target="_blank"><i class="icon-arrow-up" title="升级"></i>升级</a>
                                <?php } ?>
                                <?php } ?>
