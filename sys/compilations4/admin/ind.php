...
<body class="theme-blue">
	<div id="navigation">
        <div class="container-fluid" style="position:relative;">
            ...
            <ul class='main-nav' >
                ...
                <li><a href="/htm/help2/shiyongzhn.html">使用指南</a></li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li style="display:none"><a href="http://wpa.qq.com/msgrd?v=3&uin=2943747028&site=qq&menu=yes" target="_blank">在线客服</a></li>
            ...
            <div class="user">
                ...
                <div class="dropdown">
                    <a href="javascript:;"  target="_self" class='dropdown-toggle' data-toggle="dropdown" style="width:127px;"><nobr>zhanxingyu <span class="caret"></span><img class="thumb_img" src="" id="pic_apartpic" style="max-width:40px" /></nobr></a>
    ...
    <div class="container-fluid" id="content">
        <div id="left">
			<div class="subnav">
                <div class="subnav-title">
                    <a href="javascript:void(0);" target="_self" class='toggle-subnav'><i class="icon-angle-right"></i><span>微企</span></a>
                </div>
                <ul class="subnav-menu" style="display: block">
                    ...
                    <li>
                        <a href="/admin/main.html" target="_top">微企功能</a>
                    </li>
                  <!--   <li>
                        <a href="/admin/main.html?free=free" target="_top">永久免费功能</a>
                    </li> -->
                    <li>
                        <a href="/admin/main.html?free=all" target="_top">所有功能列表</a>
                    </li>
                    <li>
                        <a href="/admin/baseService/payset.html" >支付方式管理</a>
                    </li>
                    

                     <li>
                        <a href="/admin/userCenter/addedService.html">增值服务</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="right">
            <div class="main">
                <iframe frameborder="0" id="mainFrame" name="mainFrame" src="/admin/userCenter/pubs.html" style="background: url('http://stc.weimob.com/img/loading.gif') center no-repeat"></iframe>
            </div>
        </div>
