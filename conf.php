...
/////////////////////框架管理中心登录配置
	...
	public static $management_center_target = "configrewrewrew.yy";

	/**登录密码 ~框架管理中心登录密码 尽量复杂些*/

	public static $management_center_password = "yyucwerewrewr.net";

/////////////////////数据库配置 编码必须为 utf-8

	/**数据库地址~*/

	public static $db_host = "qiwur002.mysql.rds.aliyuncs.com";
	...
	public static $db_dbname = "weixin8";

	/**数据库用户名~*/

	public static $db_username = "dbd1p6q1r0t938v3";

	/**数据库密码~*/

	public static $db_password = "432916mysql";
...
public static $smsusername = "weiqimobile";
public static $smspassword = "pwweiqimobile";
public static $smsapi = "api.smsbao.com"; //短信网关
public static $smscharset = "utf8"; //文件编码
...
/////////////////////系统自动检测的配置信息,修改无效
	...
	'reg'=>array('protocol'=>'smtp','smtp_host'=>'smtp.qq.com','smtp_user'=>'271356340@qq.com','smtp_pass'=>'B382023119','from'=>array('','注册信息')),

	'findpwd'=>array('protocol'=>'smtp','smtp_host'=>'smtp.qq.com','smtp_user'=>'271356340@qq.com','smtp_pass'=>'B382023119','from'=>array('','密码找回'))
